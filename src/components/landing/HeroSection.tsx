...
const copy = {
  en: {
    tag: 'Financial Intelligence Platform',
    headline1: 'Know Your',
    headline2: 'Credit Health',
    headline3: 'Before Your Bank Does.',
    sub: 'Get a clear financial analysis of credit health, repayment patterns, risk signals, and the next best actions.',
    cta1: 'Start Financial Analysis',
    cta2: 'See Analysis Preview',
    stat1: '2.4L+ Analyses',
    stat2: '4.8/5 Rating',
    stat3: 'Partner Ready',
    nodes: ['Payment\nHistory', 'Credit\nUtilization', 'Loan\nAccounts', 'Credit\nAge', 'Enquiries'],
