          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="mt-10 rounded-2xl border border-white/10 bg-white/[0.045] p-6">
              ...
              <p className="text-fg-muted leading-relaxed">
                For policy questions, consent withdrawal, payment support, refund requests, or misuse reporting, contact us at support@credittrust.in. We may ask for your registered mobile number, payment reference, report request ID, and identity verification before taking action on sensitive account or report requests.
              </p>
            </div>
          </div>
        </section>
