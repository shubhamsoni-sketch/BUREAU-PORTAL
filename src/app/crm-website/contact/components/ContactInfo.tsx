    ...
    <div className="space-y-5">
      ...
      <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-5">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <p className="text-sm font-bold text-emerald-800">Talk to CreditTrust</p>
            <p className="text-xs text-emerald-700">Fastest way to reach us</p>
          </div>
        </div>
        <p className="text-xs text-emerald-700 mb-3 leading-relaxed">
          Prefer a quick response? Send us your requirement and our team will respond within a few hours.
        </p>
        <a
          href="mailto:support@credittrust.in?subject=CreditTrust%20DSA%20CRM%20Demo"
          className="w-full inline-flex items-center justify-center gap-2 bg-emerald-500 text-white font-bold text-sm px-4 py-2.5 rounded-lg hover:bg-emerald-600 transition-colors"
        >
