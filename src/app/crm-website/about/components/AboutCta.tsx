    ...
    <section className="py-16 md:py-20 bg-muted/30 border-t border-border">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        <h2 className="text-section-title font-extrabold text-primary mb-4">
          Join 2,400+ loan agents already using CreditTrust.
        </h2>
        <p className="text-base text-muted-foreground mb-8 max-w-xl mx-auto">
          Whether you are a solo DSA or running a team of 20 agents, CreditTrust gives you the tools to manage your loan business professionally.
        </p>
